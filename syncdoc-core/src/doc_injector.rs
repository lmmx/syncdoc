...
pub fn module_doc_impl() -> core::result::Result<TokenStream, TokenStream> {
    ...
    // Get the base docs path from config
    let base_path = crate::config::get_docs_path(&source_file).map_err(|e| {
